          ...
          <section>
            ...
            <ul className="space-y-2 text-[11px]">
              <li className="flex gap-2">
                <span className="text-orange-500 font-black">Commission:</span>
                <span>Swensi charges a micro-commission of <span className="text-orange-500 font-black">0.24%</span> on all completed service transactions.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-orange-500 font-black">Subscription:</span>
                <span>Partners must choose a Basic (ZMW 10/mo) or Premium (ZMW 20/mo) plan to access the lead engine.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-orange-500 font-black">Settlement:</span>
                <span>Automatic payout occurs via MTN, Airtel, or Zamtel mobile money rails.</span>
              </li>
            </ul>
          </section>
